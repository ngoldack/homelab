...
- **ADD the offsite cluster** to the existing Cilium Cluster Mesh (home=1, cloud=2, offsite=3) — shared CA, unique id/name, clustermesh-apiserver. No change to home/cloud beyond authorizing the new peer.
...
- **Mesh:** authorize offsite as a peer on home + cloud; verify `cilium clustermesh status`.
